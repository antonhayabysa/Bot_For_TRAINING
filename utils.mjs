    ...
    if (userLastQuestionIndex[userId][topic] >= 4 && !isAuthorized(ctx)) {
      throw new Error(
        "🎉 Поздравляем с успешным прохождением ознакомительной части тестов! 🎉\n\n" +
          "Чтобы продолжить и получить полный доступ ко всем тестам, оформите подписку. Это не только позволит Вам глубже подготовиться к собеседованию, но и даст доступ к регулярно обновляемым и актуализированным материалам.\n\n" +
          "🔹 Оформление подписки на 30 дней стоит всего 50 гривен.\n" +
          "🔹 Переведите сумму на указанный номер карты: [4441-1111-5285-0941].\n" +
          "🔹 После оплаты пришлите скриншот подтверждения оплаты.\n\n" +
          "Благодарим Вас за выбор нашего сервиса! Мы верим, что наши тесты помогут Вам в успешной подготовке к собеседованию и будем рады предоставлять Вам самую актуальную информацию. 🚀"
      );
    }
